...
const Details = () => {
  const { fav, setFav, details, setFilterData, filterData, setItemData } =
    ...
    <div className="details">
        ...
        <div className="details-hero">
          <div className="details-hero-header">
            ...
            <div className="details-hero-header-button-container">
              <button className="details-hero-btn" onClick={handleEdit}>
                Edit
              </button>
              <button
                onClick={() => handleDelete(details[0].id)}
          ...
          <div className="details-body">
            <div className="details-body-text">{details[0].summary}</div>
            <div className="details-body-btn-container">
              <div
                className="details-body-fav"
                onClick={() => handleFavClick(details[0].id)}
              >
                {" "}
                <AiFillStar
                  className={
                    details[0].favs === true ? "fav-active" : "fav-toggle"
                  }
                />{" "}
                |{" "}
              </div>
      ...
      <div className="details-hacktahon-body">
        <div className="details-hacktahon-body-desc">
          <div className="details-hacktahon-body-desc-title">Description</div>
          <div className="details-hacktahon-body-desc-text">
            {details[0].description}
          </div>
        </div>
        <div className="details-hacktahon-body-details">
          <div className="details-body-hackathon">Hackathon</div>
          ...
          <div className="details-body-link-btn">
            <button className="details-github-link-btn">Other Link</button>
          </div>
        </div>
      </div>
    </div>
